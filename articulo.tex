...
\begin{itemize}
    ...
    \item $a_4 = 160.823\text{ mm}$: Longitud plana del segundo eslabón móvil (distancia de codo a brida).
...
3 (2 $\rightarrow$ 3) & $\theta_2$ & 0 & $a_3 = 146.190$ & 0 \\
4 (3 $\rightarrow$ 4) & $\theta_3$ & $d_4 = -4.000$ & $a_4 = 160.823$ & 0 \\
\bottomrule
\end{tabular}
